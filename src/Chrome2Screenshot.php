...
class Chrome2Screenshot
{
	use HasScreenshotAttributes;
	...
	public function setTempFolder(string $path): Chrome2Screenshot
	{
	...
	public function setBrowserLauncher(Launcher $launcher): Chrome2Screenshot
	{
	...
	public function setContext(ContextInterface $ctx): Chrome2Screenshot
	{
		$this->ctx = $ctx;
	...
	public function appendChromeArgs(array $args): Chrome2Screenshot
	{
	...
	public function setChromeExecutablePath(?string $chromeExecutablePath): Chrome2Screenshot
	{
	...
	public function setWaitForLifecycleEvent(?string $event): Chrome2Screenshot
	{
	...
	public function setDisableScriptExecution(bool $disableScriptExecution): Chrome2Screenshot
	{
	...
	public function setTimeout(int $timeout): Chrome2Screenshot
	{
	...
	public function setEmulateMedia(?string $emulateMedia): Chrome2Screenshot
	{
	...
	public function screenshot(): ?string
	{
		...
		$screenshotOptions = $this->getScreenshotOptions();
		...
		try {
			...
			try {
				...
				$response = $devtools->page()->captureScreenshot($ctx, $screenshotOptions);
				$screenshotResult = base64_decode($response->data);
			} finally {
				$devtools->close();
			}
		} finally {
	...
	/**
	 * Populate Screenshot options
	 *
	 * @return array
	 */
	protected function getScreenshotOptions(): CaptureScreenshotRequest
	{
		$screenshotOptions = CaptureScreenshotRequest::make();
		
		$screenshotOptions->format = $this->format;
		$screenshotOptions->quality = $this->quality;
		$screenshotOptions->captureBeyondViewport = $this->captureBeyondViewport;
		$screenshotOptions->fromSurface = $this->fromSurface;
		$screenshotOptions->optimizeForSpeed = $this->optimizeForSpeed;
